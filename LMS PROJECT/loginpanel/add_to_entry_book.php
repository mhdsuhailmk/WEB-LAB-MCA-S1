...
$books_query = mysqli_query($con, "SELECT `book_id`,`book_name`, `author`, `shelf_no`, `price`, `book_edition`,`category_name` FROM book_details_tb JOIN category_tb ON category_tb.category_id = book_details_tb.category_id ORDER BY category_name ASC");
...
<body>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-10">
                                    <div class="item-content" >
                                        ...
                                        <a href="add_to_entry.php?b_id=<?php echo $row_data['book_id']; ?>"><input type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" value="Add To Entry" name="add_entry" style="float: right;"></a> 
                                        </div>
                                        <br>
                                        <br>
    ...
    <script type="text/javascript">
        function get_detail(name)
        {
            ...
            {
                type:"POST",
                url:"add_entry_book_search_ajax.php",
                datatype:'html',
