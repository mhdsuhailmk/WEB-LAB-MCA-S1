...
if(isset($_POST['add_book']))
{
    ...
    mysqli_query($con, "INSERT INTO `book_details_tb`(`book_id`,`category_id`, `book_name`, `author`, `shelf_no`, `price`, `book_edition`) VALUES('$category_id', '$book_name','$author_name', '$shelf_number', '$book_price', '$book_quantity')");
