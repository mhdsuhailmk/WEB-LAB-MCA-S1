...
$books_query = mysqli_query($con, "SELECT * FROM login_tb INNER JOIN collection_tb ON collection_tb.login_id = login_tb.login_id INNER JOIN book_details_tb ON book_details_tb.book_id=collection_tb.book_id where login_tb.login_id='$log_id' and status='1' ORDER BY collection_id ASC");
